...
```
## Окружения
Создать двух ботов и получить `BOT_TOKEN` и `LOGGS_TOKEN` у [Отца Ботов](https://telegram.me/BotFather). Один служит для отправления уведомлений от [dvmn](https://dvmn.org/), а второй для направления сообщений о логах (работоспособность бота).\
